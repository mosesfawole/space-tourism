...
const Tech = () => {
  ...
  return (
    <div>
      <div className="flex justify-center items-center title font-barlow text-white gap-4 md:justify-start md:pl-[167px] md:mt-4  mb-8">
      ...
      <div className="md:flex md:flex-row ">
        ...
        <div className="bottom mt-9 md:flex justify-center items-center  md:gap-20 md:order-first  md:flex-[80%] md:mt-0   ">
          <div className="">
          ...
          <div className="details flex flex-col justify-center items-center text-center md:text-left md:items-start  p-6 md:basis-[55%]  ">
            <div className="top mb-4">
              <p className="font-barlow text-sm text-[#D0D6F9] uppercase leading-[2.36px] md:text-base md:leading-5">
                the terminology...
              </p>
            </div>
            <div className="mb-4">
              <p className="font-bellefair text-2xl leading-7 uppercase text-white md:text-[56px] md:leading-[64px]">
                {name}
              </p>
            </div>
            <div className="">
              <p className="text-[15px] leading-6 text-[#D0D6F9] md:text-lg md:leading-8">
                {description}
              </p>
            </div>
          </div>
