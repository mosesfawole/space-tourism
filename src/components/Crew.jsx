    ...
    <div>
      <section>
        <div className="flex flex-col gap-8 ">
          <div className="top flex flex-col justify-center items-center gap-8 relative">
            ...
            <div className="">
              <img className="w-full h-[222px]" src={images.webp} alt={name} />
            </div>
            <div className="absolute bottom-0 h-[1px] w-[327px] mx-auto bg-[#383B4B]"></div>
          </div>
          ...
          <div className="bottom">
            ...
            <div className="details text-center mt-8 px-6">
              <div className="role">
                <p className="font-bellefair text-white  text-base uppercase leading-4 opacity-[0.5]">
                  {role}
                </p>
              </div>
              <div className="name mt-2 mb-4">
                <p className="text-2xl leading-7 text-white uppercase    ">
                  {name}
                </p>
              </div>
              <div className="bio">
