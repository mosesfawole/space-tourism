...
const Crew = () => {
  ...
  return (
    <div>
      <section>
        <div className="flex flex-col md:flex-row justify-center items-center md:gap-20  gap-8 ">
          <div className="top flex flex-col justify-center items-center gap-8 relative md:basis-2/6 md:order-last">
          ...
          <div className="bottom flex flex-col md:basis-[45%] ">
            <div className="hidden md:mb-28 md:flex title font-barlow text-white gap-4 md:pl-8 ">
              <p className="font-bold tracking-[2.7px] opacity-[0.25]">02</p>
              <p className="sm:text-[20px] sm:leading-6  uppercase tracking-[2.7px] ">
                Meet your crew
              </p>
